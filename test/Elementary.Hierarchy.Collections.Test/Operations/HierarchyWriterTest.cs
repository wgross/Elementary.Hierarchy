...
//    {
//        public interface NodeType : IHierarchyNodeWriter<NodeType>, IHasChildNodes<NodeType>
//        { }
...
//            var child = new Mock<NodeType>();
//            child
//                .Setup(n => n.HasChildNodes)
//                .Returns(false);

//            var parent = new Mock<NodeType>();
//            parent
//                .Setup(n => n.HasChildNodes)
//                .Returns(true);
...
//            var parentAfterFirstChange = new Mock<NodeType>();
//            var parent = new Mock<NodeType>();
//            parent
//                .Setup(n => n.HasChildNodes)
//                .Returns(true);
...
//            var child1 = new Mock<NodeType>();

//            var child2 = new Mock<NodeType>();
//            child2
//                .Setup(n => n.HasChildNodes)
//                .Returns(false);
...
//            var parentAfterSecondChange = new Mock<NodeType>();
...
//            parentAfterSecondChange.Verify(n => n.RemoveChild(It.IsAny<NodeType>()), Times.Never());
...
//                .Setup(n => n.ReplaceChild(child.Object, It.IsAny<NodeType>()))
//                .Returns(parentAfterFirstChange.Object);
...
//                .Setup(w => w.Visit(child.Object))
//                .Returns(new Mock<NodeType>().Object);
...
//            parent.Verify(n => n.HasChildNodes, Times.Once());
//            parent.Verify(n => n.ChildNodes, Times.Once());
//            parent.Verify(n => n.ReplaceChild(child.Object, It.Is<NodeType>(c => !object.ReferenceEquals(c, child.Object))), Times.Once());
//            parent.VerifyAll();
//            parentAfterFirstChange.VerifyAll();
...
//            parent // replacing the child creates a new parent node instance
//                .Setup(n => n.ReplaceChild(child1.Object, It.IsAny<NodeType>()))
//                .Returns(parentAfterFirstChange.Object);
...
//            parent.Verify(n => n.HasChildNodes, Times.Once());
//            parent.Verify(n => n.ChildNodes, Times.Once());
//            parent.Verify(n => n.ReplaceChild(child1.Object, It.Is<NodeType>(c => !object.ReferenceEquals(c, child1.Object))), Times.Once());
//            parent.VerifyAll();
//            parentAfterFirstChange.VerifyAll();
...
//                .Setup(n => n.ReplaceChild(child2.Object, It.IsAny<NodeType>()))
//                .Returns(parentAfterSecondChange.Object);
...
//            parentAfterFirstChange.Verify(n => n.ReplaceChild(child2.Object, It.IsAny<NodeType>()), Times.Once());
//            parentAfterFirstChange.VerifyAll();
...
//            parent.Verify(n => n.HasChildNodes, Times.Once());
//            parent.Verify(n => n.ChildNodes, Times.Once());
//            parent.Verify(n => n.RemoveChild(It.IsAny<NodeType>()), Times.Never());
//            parent.Verify(n => n.ReplaceChild(It.IsAny<NodeType>(), It.IsAny<NodeType>()), Times.Never());
//            parent.VerifyAll();
//        }
//    }
//}