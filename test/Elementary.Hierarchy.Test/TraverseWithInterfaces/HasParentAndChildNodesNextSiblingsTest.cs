namespace Elementary.Hierarchy.Test.TraverseWithInterfaces
{
    ...
    public class HasParentAndChildNodesNextSiblingsTest
    {
        ...
        public HasParentAndChildNodesNextSiblingsTest()
        {
            //                rootNode
            //              /         \
            //        leftNode         rightNode
        ...
        [Fact]
        public void HasParentAndChildNodes_root_node_has_no_siblings_on_NextSiblings()
        {
            // ACT

            MockableNodeType[] result = this.rootNode.Object.NextSiblings().ToArray();
        ...
        [Fact]
        public void HasParentAndChildNodes_node_returns_right_sibling_on_NextSiblings()
        {
            // ACT

            MockableNodeType[] result = this.leftNode.Object.NextSiblings().ToArray();
        ...
        [Fact]
        public void HasParentAndChildNodes_node_returns_no_siblings_on_NextSiblings()
        {
            // ACT

            MockableNodeType[] result = this.rightNode.Object.NextSiblings().ToArray();
        ...
        [Fact]
        public void HasParentAndChildNodes_node_returns_all_siblings_on_NextSiblings()
        {
            // ACT

            MockableNodeType[] result = this.rightLeaf1.Object.NextSiblings().ToArray();
