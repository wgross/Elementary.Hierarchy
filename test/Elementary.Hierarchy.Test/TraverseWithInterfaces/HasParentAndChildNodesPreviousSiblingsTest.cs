namespace Elementary.Hierarchy.Test.TraverseWithInterfaces
{
    ...
    public class HasParentAndChildNodesPreviousSiblingsTest
    {
        ...
        public HasParentAndChildNodesPreviousSiblingsTest()
        {
            //                rootNode
            //              /         \
            //        leftNode         rightNode
        ...
        [Fact]
        public void HasParentAndChildNodes_root_node_has_no_siblings_on_PreviousSiblings()
        {
            // ACT

            MockableNodeType[] result = this.rootNode.Object.PreviousSiblings().ToArray();
        ...
        [Fact]
        public void HasParentAndChildNodes_node_returns_left_sibling_on_PreviousSiblings()
        {
            // ACT

            MockableNodeType[] result = this.rightNode.Object.PreviousSiblings().ToArray();
        ...
        [Fact]
        public void HasParentAndChildNodes_node_returns_no_siblings_on_PreviousSiblings()
        {
            // ACT

            MockableNodeType[] result = this.leftNode.Object.PreviousSiblings().ToArray();
        ...
        [Fact]
        public void HasParentAndChildNodes_node_returns_all_siblings_on_PreviousSiblings()
        {
            // ACT

            MockableNodeType[] result = this.rightLeaf3.Object.PreviousSiblings().ToArray();
