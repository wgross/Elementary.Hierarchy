namespace Elementary.Hierarchy.Collections
{
    ...
    public interface IHierarchy<TKey, TValue>
    {
        ...
        /// <returns></returns>
        TValue this[HierarchyPath<TKey> path] { get;  set; }

        /// <summary>
        /// Adds a value to the hierarchy.
        /// The node must not exits or must no have a value yet
        /// </summary>
        /// <param name="path">hierachical key</param>
        /// <param name="value">value to store</param>
        void Add(HierarchyPath<TKey> path, TValue value);
        ...
        /// descenadnt nodes.
        /// </summary>
        /// <param name="path">specifed the position of the start node for removal of values</param>
